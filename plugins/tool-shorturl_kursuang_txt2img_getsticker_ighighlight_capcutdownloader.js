...
`;
  ...
  } else if (command.match(/^(short|singkatin|singkat|bitly|vgd|ouo|isgd|shortlink)$/i)) {
...
handler.command = /^(convertuang|kurs|kursuang|matauang|konversiuang|short|singkatin|singkat|bitly|vgd|ouo|isgd|caristicker|caristiker|getstiker|getsticker|igs|instagramstory|igstory|igstorydl|igh|ighighlights|ighighlight)$/i;
