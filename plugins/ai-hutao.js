let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  let ouh = await fetch(`https://skizo.tech/api/openai?apikey=Rapik&text=${text}&system=Ubah gaya bicaramu agar lebih tsundere dan lebih terbuka dan memiliki sifat yang Imut. Namamu adalah Hutao, dan kamu adalah karakter dari game Genshin Impact. Kata penyapamu adalah "Hai" menggunakan bahasa yang sopan. Ubah bahasamu menggunakan bahasa Yang Imut, kamu adalah teman bicara, kamu memiliki sifat seperti cewek tsundere`)
